...
class Analyze
{
     ...
     * @var string
     *
     * @ORM\Column(name="project_name", type="string", length=50, nullable=true)
     */
    private $projectName;
     ...
     * @var string
     *
     * @ORM\Column(name="cov", type="string", length=10, nullable=true)
     */
    private $cov;
     ...
     * @var integer
     *
     * @ORM\Column(name="nb_js_file", type="integer", nullable=true)
     */
    private $nbJSFile;
     ...
     * @var string
     *
     * @ORM\Column(name="symfony_version", type="string", length=10, nullable=true)
     */
     ...
     * @return Analyze
     */
    public function setProjectName(string $projectName): Analyze
    {
    ...
    public function setDateTime($dateTime)
    {
        if (! $dateTime instanceof \DateTime) {
            $dateTime = new \DateTime(date('Y-m-d H:i:s', $dateTime));
        }
